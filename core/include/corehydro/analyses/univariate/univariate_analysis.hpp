...
class UnivariateAnalysis : public AnalysisBase, public IUnivariateAnalysis {
   public:
    ...
    corehydro::estimation::BayesianAnalysis& bayesian_analysis() override {
    ...
    void create_chronology_results() {
        ...
        for (std::size_t col = 0; col < length; ++col) {
            ...
            mean[col] = corehydro::numerics::data::mean(data);
            ci[col][0] = corehydro::numerics::data::percentile(data, a, true);
            ci[col][1] = corehydro::numerics::data::percentile(data, 1.0 - a, true);
        }
    ...
    corehydro::models::ValidationResult validate() const override {
        ...
        corehydro::models::ValidationResult dist_valid = univariate_distribution_->validate();
