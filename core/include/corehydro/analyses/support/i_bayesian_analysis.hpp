...
class IBayesianAnalysis : public virtual IAnalysis {
   public:
    ...
    virtual corehydro::estimation::BayesianAnalysis& bayesian_analysis() = 0;
    ...
    virtual const corehydro::numerics::distributions::UncertaintyAnalysisResults* analysis_results()
        const = 0;
};
