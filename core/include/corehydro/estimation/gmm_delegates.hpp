...
struct MomentConditionResult {
    corehydro::numerics::math::linalg::Vector G;
    corehydro::numerics::math::linalg::Matrix S;
};
...
using JacobianFunction =
    std::function<corehydro::numerics::math::linalg::Matrix2D(const std::vector<double>&)>;
