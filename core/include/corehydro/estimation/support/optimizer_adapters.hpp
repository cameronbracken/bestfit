...
namespace corehydro::estimation::detail {

// Adapts BrentSearch (see this file's header ADAPTER NOTE) to the `Optimizer` interface.
class BrentOptimizerAdapter final : public corehydro::numerics::math::optimization::Optimizer {
    using Base = corehydro::numerics::math::optimization::Optimizer;
   ...
   protected:
    void optimize() override {
        int evaluations = 0;
        corehydro::numerics::math::optimization::BrentSearch solver(
        ...
        best_parameter_set_ = corehydro::numerics::math::optimization::ParameterSet(
            best, static_cast<double>(function_scale_) * raw);
        update_status(corehydro::numerics::math::optimization::OptimizationStatus::Success);
    }
...
class NelderMeadOptimizerAdapter final : public corehydro::numerics::math::optimization::Optimizer {
    using Base = corehydro::numerics::math::optimization::Optimizer;
   ...
   protected:
    void optimize() override {
        int evaluations = 0;
        corehydro::numerics::math::optimization::NelderMead solver(
