...
#include "bestfit/numerics/math/linalg/lu_decomposition.hpp"  // defines Matrix::inverse/determinant
...
class LeverageDiagnostics {
   public:
    ...
    class ObservationLeverage {
       public:
        ObservationLeverage(int index, double leverage, double percent_of_total,
                            ...
                            double value, bestfit::models::DataComponentType data_type,
        ...
        bestfit::models::DataComponentType data_type() const { return data_type_; }
       ...
       private:
        ...
        double value_;
        bestfit::models::DataComponentType data_type_;
        int count_;
    ...
    class PriorComponentLeverage {
       public:
        PriorComponentLeverage(std::string name, bestfit::models::PriorComponentType type,
    ...
    LeverageDiagnostics(bestfit::models::ModelBase& model, const std::vector<double>& map_values)
    ...
    static Matrix compute_numerical_hessian_public(
        ...
        return bestfit::estimation::NumericalDiff::compute_hessian(function, parameters, p);
    }
   ...
   private:
    ...
    void compute_leverages(bestfit::models::ModelBase& model,
        ...
        try {
            ...
            try {
                ...
                try {
                    neg_hessian = bestfit::numerics::math::linalg::MatrixRegularization::
    ...
    void compute_observation_leverages(bestfit::models::ModelBase& model,
                                       const std::vector<double>& map_values, int p,
                                       const Matrix& hessian_inv) {
        namespace nd = bestfit::estimation;
        ...
        std::vector<bestfit::models::DataComponent> data_components;
        ...
        for (int i = 0; i < n; ++i) {
            ...
            double value = 0;
            auto data_type = bestfit::models::DataComponentType::Exact;
            int count = 1;
    ...
    void compute_prior_component_leverages(bestfit::models::ModelBase& model,
                                           const std::vector<double>& map_values, int p,
                                           const Matrix& hessian_inv) {
        std::vector<bestfit::models::PriorComponent> base_components;
        try {
    ...
    static double compute_generalized_variance_influence(
        ...
        try {
            ...
            Matrix hessian_reduced = bestfit::estimation::NumericalDiff::compute_hessian(
            ...
            try {
                ...
                neg_hessian_reduced = bestfit::numerics::math::linalg::MatrixRegularization::
