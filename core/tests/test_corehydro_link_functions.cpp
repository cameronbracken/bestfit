...
#include "corehydro/models/link_functions/best_fit_link_function_factory.hpp"
...
using corehydro::models::link_functions::BestFitLinkFunctionFactory;
using corehydro::models::link_functions::BestFitLinkFunctionType;
using corehydro::models::link_functions::CenteredLink;
using corehydro::models::link_functions::LogASinHLink;
using corehydro::models::link_functions::LogSESLink;
using corehydro::models::link_functions::SESLink;
...
void test_factory_all_types() {
    ...
    CHECK_TRUE(dynamic_cast<ch_numfun::LogitLink*>(
                   BestFitLinkFunctionFactory::create(LinkFunctionType::Logit).get()) !=
               nullptr);
    CHECK_TRUE(dynamic_cast<ch_numfun::ProbitLink*>(
                   BestFitLinkFunctionFactory::create(LinkFunctionType::Probit).get()) !=
               nullptr);
    CHECK_TRUE(
        dynamic_cast<ch_numfun::ComplementaryLogLogLink*>(
...
int main() {
    ...
    return chtest::summary("test_corehydro_link_functions");
}
