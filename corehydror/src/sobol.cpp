...
// Core header is vendored under src/corehydro_core/include (a symlink into core/; regenerate real files with tools/materialize_core.py).
...
[[cpp11::register]]
doubles_matrix<by_column> ch_sobol_generate_(int dimension, int n_steps,
                                              std::string path) {
