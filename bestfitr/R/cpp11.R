...
bf_analysis_univariate_run_ <- function(model_json, dataset, sampler, iterations, output_length, credible_level, seed, exceedance_probabilities, thinning_interval) {
  .Call(`_bestfitr_bf_analysis_univariate_run_`, model_json, dataset, sampler, iterations, output_length, credible_level, seed, exceedance_probabilities, thinning_interval)
}

bf_analysis_fit_distributions_ <- function(dataset) {
  .Call(`_bestfitr_bf_analysis_fit_distributions_`, dataset)
}

bf_analysis_b17c_run_ <- function(model_json, dataset, uncertainty_method, output_length, seed, confidence_level, exceedance_probabilities) {
