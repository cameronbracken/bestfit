...
// spatial-extremes types in bestfit::models::spatial_extremes. SpatialGEV joins them there,
// correcting the plan/requirements shorthand bestfit::models::SpatialGEV.
//
// -------------------------------------------------------------------------------------------
