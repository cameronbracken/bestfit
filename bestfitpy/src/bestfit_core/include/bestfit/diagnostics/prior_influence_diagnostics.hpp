...
//   - The C# `IModel` is realized in this core by `bestfit::models::ModelBase` (there is no
//     separate IModel header; the estimators all hold `ModelBase&`), so the primary constructor
//     takes `ModelBase& model`. `MCMCResults` is
//     `bestfit::numerics::sampling::mcmc::MCMCResults` (its `Output` -> `.output`, each sample's
...
class PriorInfluenceDiagnostics {
   public:
    ...
    class PriorComponentSummary {
       public:
        PriorComponentSummary(std::string name, bestfit::models::PriorComponentType type,
        ...
        bestfit::models::PriorComponentType type() const { return type_; }
       ...
       private:
        std::string name_;
        bestfit::models::PriorComponentType type_;
    ...
    PriorInfluenceDiagnostics(bestfit::models::ModelBase& model, const MCMCResults& results,
                              int thin_every = 10) {
    ...
    std::vector<PriorComponentSummary> get_components_by_type(
        bestfit::models::PriorComponentType type) const {
    ...
    std::map<bestfit::models::PriorComponentType, double> get_contribution_by_type() const {
        std::map<bestfit::models::PriorComponentType, double> result;
    ...
    std::string get_summary() const {
        ...
        std::vector<std::pair<bestfit::models::PriorComponentType, double>> ordered(by_type.begin(),
                                                                                    by_type.end());
   ...
   private:
    ...
    void compute_from_posterior(bestfit::models::ModelBase& model, const MCMCResults& results,
                                int thin_every) {
        ...
        std::map<std::string, bestfit::models::PriorComponentType> type_dict;
        ...
        for (int s = 0; s < s_count; s += step) {
            ...
            std::vector<bestfit::models::PriorComponent> prior_components =
    ...
    void compute_prior_precision_share(bestfit::models::ModelBase& model,
    ...
    static std::string prior_type_name(bestfit::models::PriorComponentType type) {
        switch (type) {
            case bestfit::models::PriorComponentType::ParameterPrior:
                return "ParameterPrior";
            case bestfit::models::PriorComponentType::QuantilePrior:
                return "QuantilePrior";
            case bestfit::models::PriorComponentType::JeffreysScalePrior:
                return "JeffreysScalePrior";
            case bestfit::models::PriorComponentType::SpatialError:
                return "SpatialError";
            case bestfit::models::PriorComponentType::Jacobian:
                return "Jacobian";
            case bestfit::models::PriorComponentType::OtherPenalty:
                return "OtherPenalty";
            default:
                return "Unknown";
        }
