...
class RatingCurveAnalysis : public AnalysisBase {
   public:
    using RatingCurve = bestfit::models::RatingCurve;
    ...
    void create_uncertainty_analysis_results() {
        ...
        bestfit::numerics::sampling::MersenneTwister prng(static_cast<std::uint32_t>(prng_seed));
        ...
        for (int i = 0; i < n; ++i) {
            ...
            r.mean_curve[ui] = bestfit::numerics::data::mean(q);
            ...
            r.confidence_intervals[ui][0] =
                bestfit::numerics::data::percentile(q, alpha / 2.0, true);
            r.confidence_intervals[ui][1] =
                bestfit::numerics::data::percentile(q, 1.0 - alpha / 2.0, true);
        }
    ...
    bestfit::models::ValidationResult validate() const override {
        ...
        bestfit::models::ValidationResult model_valid = rating_curve_->validate();
   ...
   private:
    ...
    static std::vector<double> build_stage_bins(double min, double max, int n) {
        ...
        auto x_bins = bestfit::numerics::sampling::Stratify::XValues(
            bestfit::numerics::sampling::StratificationOptions(min, max, n - 1));
    ...
    static double stage_series_max(const bestfit::numerics::data::TimeSeries& series) {
