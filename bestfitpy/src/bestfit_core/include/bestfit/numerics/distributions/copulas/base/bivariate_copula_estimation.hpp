...
#include "bestfit/numerics/distributions/copulas/base/copula_estimation_method.hpp"
...
inline void mle(BivariateCopula& copula, const std::vector<double>& sample_data_x,
    ...
    auto* margin1 = dynamic_cast<bestfit::numerics::distributions::IMaximumLikelihoodEstimation*>(
        copula.marginal_distribution_x.get());
    auto* margin2 = dynamic_cast<bestfit::numerics::distributions::IMaximumLikelihoodEstimation*>(
    ...
    auto rank1 = bestfit::numerics::data::ranks_in_place(sample_data_x);
    auto rank2 = bestfit::numerics::data::ranks_in_place(sample_data_y);
    ...
    // Estimate marginals.
    auto* est1 = dynamic_cast<bestfit::numerics::distributions::IEstimation*>(
        copula.marginal_distribution_x.get());
    auto* est2 = dynamic_cast<bestfit::numerics::distributions::IEstimation*>(
        copula.marginal_distribution_y.get());
    est1->estimate(sample_data_x, bestfit::numerics::distributions::ParameterEstimationMethod::MaximumLikelihood);
    est2->estimate(sample_data_y, bestfit::numerics::distributions::ParameterEstimationMethod::MaximumLikelihood);
